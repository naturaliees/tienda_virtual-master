...
SECRET_KEY = 'django-insecure-2cqj%#)od7h1@#&@0khtk)eaviiclc*#d0^y#j9xcmf=j)t4lu'
...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles',
    'rest_framework',              # <--- DRF
    'renta',                       # <--- Nuestra aplicación
    'rest_framework_simplejwt',
]

# config/settings.py

# ... después de las importaciones y la lista INSTALLED_APPS
AUTH_USER_MODEL = 'renta.Cliente'
...
DATABASES = {
    'default': {
        'ENGINE': 'sql_server.pyodbc',  # Usamos el adaptador de SQL Server
        'NAME': 'bd_tiendarenta',      # El nombre de la DB que creaste en tu SQL
...
SIMPLE_JWT = {
    ...
    'USER_ID_FIELD': 'id_cliente', # Usaremos un campo personalizado de tu modelo Cliente
